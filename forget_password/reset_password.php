    ...
    <section class="classiera-navbar   classiera-navbar-v6 ">
      ...
      <nav id="myNavmenu" class="navmenu navmenu-default offcanvas offcanvas-light navmenu-fixed-left" role="navigation">
        ...
        <div class="social-network">
          ...
          <!--FacebookLink-->
          <a href="https://facebook.com/joinwebs" class="social-icon social-icon-sm offcanvas-social-icon" target="_blank">
            <i class="fab fa-facebook-f"></i>
          </a>
          <!--twitter-->
          <a href="https://twitter.com/joinwebs" class="social-icon social-icon-sm offcanvas-social-icon" target="_blank">
          ...
          <!--YouTube-->
          <!--Google-->
          <a href="https://google.com/+joinwebs" class="social-icon social-icon-sm offcanvas-social-icon" target="_blank">
