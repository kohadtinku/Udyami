...
<head>
  ...
  <title>Add Lisiting -User_management</title>
...
<body onload="validate_user()">
  ...
  if (isset($_FILES['listing_pdf'])) {
    ...
    try {
      $insert_query = "INSERT INTO `listing` (`listing_id`, `listing_business_name`, `listing_business_category_id`, `listing_keyword`, `listing_tag`, `listing_cost`, `listing_business_sub_category_id`, `listing_description`,`listing_firm_name`, `listing_country_id`, `listing_pincode`, `listing_state_id`, `listing_location`, `listing_city_id`, `listing_image`,`listing_image2`,`listing_image3`,`listing_pdf`, `listing_timestamp`, `listing_status_timestamp`, `listing_status`, `listing_permission`, `listing_owner_id`) VALUES (NULL, '$listing_title', '$category_id', '$keywords', '$tags', '$price', '$sub_category_id', '$listing_description','$listing_firm_name', '1', '$pincode', '$state_id', '$address', '$city_id', '$logo_image1','$logo_image2','$logo_image3','$listing_pdf',  current_timestamp(),  current_timestamp(), 'Pending', 'Pending', '" . $_SESSION['slave_id'] . "')";
