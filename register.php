...
<body>
  ...
  <script type="text/javascript">
    function validation_for_email_username_phone() {
      ...
      phone = phone.value;
      $.ajax({
        url: "./service/validation_for_phone.php",
        datatype: "JSON",
        type: "POST",
        data: {
          submit: "submit",
        ...
        success: function(result) {
          ...
          if (0 < (json_data[2][1]).length) {
            document.getElementById("verify_phone_otp_btn").disabled = true;
            document.getElementById("verify_phone_btn").disabled = true;
          } else {
            document.getElementById("verify_phone_otp_btn").disabled = false;
            document.getElementById("verify_phone_btn").disabled = false;
          }
        }
      });
    }
          ...
          <div class="tab_content" id="verify_phone_for_register">
            <form enctype="multipart/form-data" method="post" class="login">
              ...
              <p class="utf_row_form utf_form_wide_block" id='btn_submit_otp'>
                <label>
                  <input type="submit" id="verify_phone_otp_btn" class="button border fw margin-top-10" name="verify_phone_otp_btn" value="Verify Phone No." />
                </label>
              </p>
