            ...
            <form enctype="multipart/form-data" method="post" class="register">
              ...
              <p class="utf_row_form utf_form_wide_block">
                <label for="register_first_name">First Name
                  <input class="input-text" type="text" name="register_first_name" id="register_first_name" placeholder="First Name"  required/>
                </label>
              </p>
              <p class="utf_row_form utf_form_wide_block">
                <label for="register_last_name">Last Name
                  <input class="input-text" type="text" name="register_last_name" id="register_last_name" placeholder="Last Name"  required/>
                </label>
              </p>
              <?php echo "<h4 style='color:red;' id='label_for_username_validation'></h4>"; ?>
              <p class="utf_row_form utf_form_wide_block">
                <label for="register_username">Username
                  <input type="text" class="input-text" onchange="validation_for_email_username_phone()" onload="validation_for_email_username_phone()" name="register_username" id="register_username" value="" placeholder="Username"  required/>
                </label>
              </p>
              ...
              <p class="utf_row_form utf_form_wide_block">
                <label for="register_email">Email
                  <input type="email" class="input-text" onchange="validation_for_email_username_phone()" onload="validation_for_email_username_phone()" name="register_email" id="register_email" value="" placeholder="Email"  required/>
                </label>
              </p>
