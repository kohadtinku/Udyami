  ...
  <div class="utf_dashboard_navigation_inner_block">
    <ul>
      ...
      <li  id="user_dashboard_my_listing">
        <a href="dashboard_my_listing.php"><i class="sl sl-icon-layers"></i> All Listings</a>
      ...
      <li id="user_dashboard_category"><a href="dashboard_category.php"><i class="sl sl-icon-plus"></i>All Category</a></li>
      <li id="user_dashboard_add_category"><a href="addcategory.php"><i class="sl sl-icon-plus"></i> Add Category</a></li>
      <li id="user_dashboard_edit_sub_category"><a href="editsubcategory.php"><i class="sl sl-icon-plus"></i> Edit Sub Category</a></li>
      ...
      <li id="user_dashboard_enquery"><a href="dashboard_enquery.php"><i class="sl sl-icon-bell"></i>All Enquery</a></li>
      ...
      <li id="user_dashboard_user_manegement"><a href="dashboard_user_management.php"><i class="sl sl-icon-user"></i> User Management</a></li>
