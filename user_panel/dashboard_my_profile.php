									...
									if (false) {
										...
										<div class="my-profile">
											<div class="row with-forms">
													...
													<input type="text" class="input-text" id="user_username" name="" value="<?= $row['user_username'] ?>" <?php if (($_SESSION['user_type'] == 'admin' || $_SESSION['user_type'] == 'user_manager') || $_SESSION['user_type'] != 'inspector') {																																												} else {
														echo 'disabled';
													}  ?> disabled>
