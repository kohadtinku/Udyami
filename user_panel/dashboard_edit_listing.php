...
<head>
  ...
  <title>Upadate Listing- user</title>
          ...
          if (($_SERVER["REQUEST_METHOD"] == "POST") && (isset($_POST["updateList"]) && isset($_POST['listing_id']))) {
            ...
            if (isset($_FILES['listing_pdf'])) {
              if ("" != $_FILES["listing_pdf"]["tmp_name"]) {
                unlink_img('listing_pdf', 'listing', 'listing_id', $listing_id, $connect);
                ...
                <div id="utf_add_listing_part">
                  <form enctype="multipart/form-data" method="POST" action="<?= $_SERVER["REQUEST_URI"]; ?>">
                    ...
                    <div class="add_utf_listing_section margin-top-45" validate>
                      ...
                      <input type="text" class="" name="listing_firm_name" id="listing_firm_name" value="<?= $row['listing_firm_name'] ?>" required />
                    </div>
                        <div class="col-md-6">
                    ...
                    <div class="add_utf_listing_section margin-top-45">
                      ...
                      <div class="row with-forms">
                        ...
                        <div class="utf_submit_section col-md-4">
                          ...
                          <!-- <form enctype="multipart/form-data" ></form> -->
                          <div class="">
                            <input type="file" accept="application/pdf,application/vnd.ms-excel" name="listing_pdf" id="listing_pdf">
                          </div>
                          <?php if ($listing_pdf != "") {
                          ?><h4>Present PDF 1</h4><?php
                                                  } ?>

                          <div class="">
                           <?php if ($listing_pdf != "") {
                                          echo ' <input type="text"  value="'.substr($listing_pdf,10).'" disabled>';
                                          
                                        } else {
                                          echo ' <input type="text"  value="Currently No File Available" disabled>';
                                        } ?>
                          </div>
